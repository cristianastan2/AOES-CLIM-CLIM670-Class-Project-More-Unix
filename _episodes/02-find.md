...
#### This episode is taken from the [Software Carpentry Unix Shell Lesson](http://swcarpentry.github.io/shell-novice/)
...
~~~
$ cd
$ cd classes/clim670/data-shell/writing
$ cat haiku.txt
~~~
{: .language-bash}
...
> and powerful. As a taster, we can find lines that have an 'o' in the second position like this:
>
> ~~~
> $ grep -E "^.o" haiku.txt
> ~~~
